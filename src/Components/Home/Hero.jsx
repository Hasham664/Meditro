...
export default function Hero() {
  return (
    <div>
      <div className="flex h-screen justify-center items-center text-white bg-gray-800">
        <div className="text-center max-w-6xl mx-10">
          ...
          <div>
            <p className="max-w-2xl mx-auto my-2 text-base text-white md:leading-relaxed md:text-xl dark:text-gray-400">
